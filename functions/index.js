...
const Spotify = new SpotifyWebApi({
  ...
  redirectUri: `https://poop-a1c0e.firebaseapp.com`,
});

// Scopes to request.
const OAUTH_SCOPES = ['user-read-email', 'user-read-currently-playing', 'user-modify-playback-state', 'streaming', 'user-read-playback-state', 'user-top-read','user-read-email'];
